...
<body>
  ...
  <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
      <h2 class="mb-4 text-xl text-center font-bold ">Login</h2>
      <p class="text-sm text-center opacity-60">note: "hubungkan koneksi internet untuk style yang lebih baik"</p>
      <?php session_start(); ?>
    ...
    <div class="text-xs font-semibold">
        ...
        <?php unset($_SESSION['error']) ?>
          ...
          <div class="flex flex-col">
              ...
              <a href="daftar.php">tidak memiliki akun? register</a>
              </div>
      </form>
  </div>
</section>
