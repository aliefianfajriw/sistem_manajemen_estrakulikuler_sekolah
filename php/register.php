...
if (isset($_POST['nama'],  $_POST['sandi'], $_POST['role'], $_POST['kelas'])) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO users (nama, sandi, role, kelas) VALUES ('$nama', '$hashedPassword', '$role', $kelasValue)");
